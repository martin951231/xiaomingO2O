...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getWarnType(){
                let that = this
                that.request('/community/platform.device.GarbageCollectionWarn/getWarnType', {}).then((res) => {
                    that.typeList = res
                })
            },
            getData(){
                ...
                that.request('/community/platform.device.GarbageCollectionWarn/warnList', that.pageInfo).then((res) => {
