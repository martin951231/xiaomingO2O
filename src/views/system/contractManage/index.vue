<template>
    <div class="contract_manage">
        ...
        <div class="btn_con">
            <a-button style="margin-right: 10px;" type="primary" @click="addContract">添加合同</a-button>
        ...
        <div class="table_con">
            <a-table :rowKey="record=>record.id" :columns="tableColumns" :loading="tableLoading" :data-source="contractList" @change="handleTableChange">
                <template slot="action" slot-scope="text, record">
                    <a-button type="link" @click="editContract(record.id)">编辑</a-button>
    ...
    export default {
        ...
        methods: {
            ...
            getContractList() {
                ...
                this.request('/community/platform.contract.Index/getList', params).then(res => {
            ...
            deleteConfirm(id){
                this.request('/community/platform.contract.Index/deleteContractInfo', {id, }).then(res=>{
                    this.getContractList()
