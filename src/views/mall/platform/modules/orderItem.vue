<template>
    <div class="order-item-wrap">
        <a-row type="flex" justify="space-between" align="top" class="order-item-header">
            <a-col flex="1" style="padding-top: 5px;">
                <div class="text-wrap">
                ...
                <a-row type="flex" justify="space-between" class="height-inherit">
                    <a-col :span="4">
                        <div class="content-item">
                            ...
                            <span class="text-center">{{ order.address }}</span>
                        </div>
                    </a-col>
                    <a-col :span="4">
                        <div class="content-item">
                    ...
                    <a-col :span="4">
                        <div class="content-item">
                            ...
                            <span v-if="order.current_time" class="cr-red">
                                {{ moment(order.current_time).format('YYYY.MM.DD') }}送达
                            </span>
                            <span
...
export default {
    ...
    methods: {
        ...
        orderDetail() {
            ...
            if (refund_id && this.order.status >= 60 && this.order.status < 80) {
                query.refund_id = refund_id
            }
            let routeData = this.$router.resolve({ path: '/mall/platform.orderMange/orderDetail', query })
        ...
        orderPrintTicket() {
            ...
            this.request(mallPlatformApi.orderPrintTicket, params).then(data => {
