<template>
    <div class="mt-10 mb-20 pt-20 pl-20 pr-20 pb-20 bg-ff br-10">
        ...
        <a-form-model layout="inline" :model="searchForm" @submit="getOrderList" @submit.native.prevent>
            ...
            <a-form-item label="手动搜索" class="serch a-form-item">
                <a-input-group compact>
            ...
            <a-form-item label="配送方式" class="a-form-item">
                <a-select class="input-class" placeholder="请选择" v-model="searchForm.express_type" style="min-width: 135px;">
            ...
            <a-form-item label="订单来源" class="a-form-item">
                <a-select class="input-class" placeholder="请选择" v-model="searchForm.source" style="min-width: 135px">
        ...
        <div v-show="tabList.length" class="mt-50">
            ...
            >
                <a-tab-pane v-for="item in tabList" :key="item.status">
                    <span slot="tab">
                        <a-badge @click="changeColor(item.status)">
                            {{ item.label }} </a-badge
                        ><br />
                        <a-badge
                            align="middle"
                    ...
                    <div class="order-header">
                        <a-row type="flex" justify="space-between" align="middle">
                            ...
                            <a-col :span="16">
                                <a-row type="flex" justify="space-between" align="middle">
                                    <a-col :span="4" class="text-center">收货人/手机</a-col>
...
export default {
    ...
    data() {
        return {
            ...
            exportUrl: mallMerchantApi.exportOrder,
            defaultActiveKey: '3',
            total: 0,
            orderList: [],
            simpleImage: '',
    ...
    created() {
        ...
        this.$set(this.searchForm, 'store_id', this.$route.query.store_id)
        this.getOrderList()
    },
    ...
    methods: {
        ...
        getOrderList(order_id = '') {
            ...
            if (!this.searchForm.status) {
                this.$set(this.searchForm, 'status', 3)
            }
            this.request(mallMerchantApi.getOrderList, this.searchForm)
                .then((data) => {
