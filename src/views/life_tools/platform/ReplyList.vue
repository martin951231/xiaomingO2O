  ...
  <div class="mt-10 mb-20 pt-20 pl-20 pr-20 pb-20 bg-ff br-10">
    ...
    <a-form-model layout="inline" :model="searchForm">
      <a-form-model-item label="搜索">
        ...
        >
          ...
          <a-select-option :value="4"> 商家</a-select-option>
        </a-select>
    ...
    <a-table class="mt-20" rowKey="rpl_id" :columns="columns" :data-source="dataList" :pagination="pagination">
      <span slot="type" slot-scope="text">
        <a-badge v-if="text == 'course'" status="default" text="体育课程" />
        <a-badge v-if="text =='stadium'" status="default" text="体育馆" />
        <a-badge v-if="text =='scenic'" status="default" text="景区" />
      </span>
      <!-- 自定义table部分标题 -->
...
import ReplyUser from "../../life_tools/platform/modules/replyUser";
