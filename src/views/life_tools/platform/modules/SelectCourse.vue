  ...
  <div style="margin-top: 5px;padding:10px;background-color: #fff;">
    <a-form-model layout="inline" :model="searchForm">
      <a-form-model-item label="课程标题">
        <a-input v-model="searchForm.title" placeholder="课程标题"></a-input>
      </a-form-model-item>
        <a-form-model-item>
...
export default {
  ...
  methods: {
    ...
    getDataList(is_search) {
      ...
      this.request(lifeToolsPlatformApi.getCourseList, params).then((res) => {
    ...
    handleOk() {
        if (this.selectedRowKeys.length) {
          this.request(lifeToolsPlatformApi.addRelatedCourse, {
