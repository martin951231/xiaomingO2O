...
export default {
  ...
  methods: {
    ...
    getDataList(is_search) {
      ...
      this.request(lifeToolsPlatformApi.getSportsHotRecommendList, params).then((res) => {
    ...
    handleOk() {
        if (this.selectedRowKeys.length) {
          this.request(lifeToolsPlatformApi.addSportsHotRecommendList, {
