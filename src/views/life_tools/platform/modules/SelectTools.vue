      ...
      <a-form-model-item label="标题">
        ...
        <a-form-model-item label="类型">
            ...
            >
                ...
                <a-select-option value="stadium">场馆</a-select-option>
                <a-select-option value="course">课程</a-select-option>
                <a-select-option value="appoint">通用预约</a-select-option>
            </a-select>
        </a-form-model-item>
        <a-form-model-item>
...
export default {
  ...
  methods: {
    ...
    getDataList(is_search) {
      ...
      this.request(lifeToolsPlatformApi.getToolsList, params).then((res) => {
    ...
    // 重置表单
    resetForm() {
      this.$set(this, 'searchForm', {name: '', status: -1, type:"scenic"})
      this.$set(this.pagination, 'current', 1)
      this.getDataList()
    },
    // 页码变化
    ...
    handleOk() {
        if (this.selectedRowKeys.length) {
          this.request(lifeToolsPlatformApi.addRelatedTools, {
            tools_id: this.selectedRowKeys,
