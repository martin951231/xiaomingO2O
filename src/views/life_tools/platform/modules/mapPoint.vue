  ...
  <a-modal :title="title" :width="1000" :height="500" :visible="visible" @cancel="closeWindow" :footer="null">
    ...
    <a-row>
            ...
            <a-col :span="19" style="padding-left: 20px;">
                ...
                <baidu-map class="bm-view" :center="mapConfig.center" @click="clickMap" :scroll-wheel-zoom="true"
                  :zoom="mapConfig.zoom" @ready="mapReady" :ak="AK" id="">
                  ...
                  <bm-geolocation anchor="BMAP_ANCHOR_BOTTOM_RIGHT" :showAddressBar="true" :autoLocation="true">
                   ...
                   <bm-overview-map anchor="BMAP_ANCHOR_BOTTOM_RIGHT" :isOpen="true"></bm-overview-map>
                    ...
                    <bm-local-search :keyword="keyword" :page-capacity="10" @infohtmlset="searchSelectPoint" :auto-viewport="true" class="search-item"></bm-local-search>
                
                
                  <bm-marker v-if="isShowMapSign" :position="clickMapShow.position" :dragging="true">
