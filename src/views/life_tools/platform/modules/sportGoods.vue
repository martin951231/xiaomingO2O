<template>
    <div class="mt-10 mb-20 mh-full">
        ...
        >
            ...
            <a-card style="margin-top: 10px" title="体育信息" :bordered="false">
                <a-form-model-item label="体育" :wrapper-col="{span: 23}" :labelCol="{ span: 1}">
                    <a-row>
                        <a-col :span="12" class="text-left">
                            <a-button @click="addProduct('sport')" type="primary"> 添加体育 </a-button>
                        </a-col>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getOpen() {
                this.request(lifeToolsPlatformApi.getRecGoodsList, {goods_type:'sport'}).then((res) => {
