<template>
    ...
    <a-card  :bordered="false">
        ...
        <a-card style="margin-top: 10px" title="文旅信息" :bordered="false">
            <a-form-model-item label="文旅" :wrapper-col="{span: 23}" :labelCol="{ span: 1}">
                <a-row>
                    <a-col :span="12" class="text-left">
                        <a-button @click="addProduct('ticket')" type="primary"> 添加文旅 </a-button>
                    </a-col>
...
<script>
    ...
    export default {
        name: "ticketGoods",
        components: {ACol, ARow, SelectRecGoods},
        data() {
            return {
                columns,
                data:[],
        ...
        methods: {
            ...
            getOpen() {
                this.request(lifeToolsPlatformApi.getRecGoodsList, {goods_type:'ticket'}).then((res) => {
