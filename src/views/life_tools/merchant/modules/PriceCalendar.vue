    ...
    <div>
        ...
        >
            <div class="edit-price">
                <a-row :gutter="gutter">
                    <a-col :span="span.left"> 门票名称：</a-col>
                ...
                <a-row :gutter="gutter">
                    ...
                    <a-col :span="span.right" v-if="dayPriceChange">
                        <a-input-number :min="0" v-model="formData.price" placeholder="请输入价格" style="width: 300px" />
                    </a-col>
...
export default {
    ...
    methods: {
        ...
        getPriceList() {
            ...
            if (this.rule.price_calendar && this.rule.price_calendar.length) {
                ...
                for (let i = 0; i < dayNum2; i++) {
                    const day2 = moment().add(i, 'day').format('YYYY-MM-DD')
                    day2 = moment(day2)
                    const key2 = day2.unix()
                    if(!this.priceList[key2] ){
                        this.priceList[key2] = {
                ...
                for (let i = 0; i < dayNum; i++) {
                    ...
                    this.priceList[key] = { price: this.rule.price, is_sale: 1, day: formatDay }
                }
            }
        },
        // 点击确定
        handleSubmit() {
            this.$emit('getPriceList', { priceList: this.priceList })
            this.handleCancel()
        },
        // 点击关闭
        handleCancel() {
        ...
        headerRender({ value, type, onChange, onTypeChange }) {
            ...
            const ruleName =  this.rule.title
            return (
        ...
        handlePriceChange() {
            ...
            if (
                ...
                (this.formData.price === '' || this.formData.price == null)
            ) {
