                ...
                >
                    <a-card :bordered="false" v-show="current == 0">
                        ...
                        <a-form-item label="技师名称" :required="true" :help="L('建议填写真实姓名')">
                            <a-row>
                                <a-col :span="18">
                                    <a-input placeholder="请输入名称" v-model="formData.name" :maxLength="8"></a-input>
                                </a-col>
                        ...
                        <a-form-item label="岗位" :required="true">
                            <a-select :value="formData.job_id" @change="handleCountryChange">
                        ...
                        <a-form-item label="简介" :required="true">
                    ...
                    <a-card :bordered="false" v-show="current == 1">
                        ...
                        <a-form-item label="详细描述">
                            <a-textarea :rows="4" placeholder="请输入详细描述" v-model="formData.detail"
    ...
    export default {
        ...
        methods: {
            ...
            onDateStartChange(start_time_moment, start_time) {
                ...
                //console.log(start_time, "start_timestart_timestart_timestart_time===start_timestart_time");
                // this.$set(this.formData, 'job_time', start_time)
            },
            add(store_id) {
                this.person_id = ""
