                ...
                >
                    ...
                    >
                        ...
                        <!--<span slot="cat_fid" slot-scope="text,record">
                             <a @click="getChildList(record.cat_id)">查看</a>
                        </span>-->
                        <router-link
                                :to="{
                                path: '/platform/platform.merchant/StoreCategoryChildList',
                                query: { cat_id: record.cat_id },
                            }"
                                slot="cat_fid"
                                slot-scope="text, record"
                        >
                            <a class="label-sm-1">查看</a>
                        </router-link>
                        ...
                        <template slot="title" slot-scope="currentPageData">
                            <a-row type="flex" justify="center" align="top">
                                <a-col :span="4" class="text-left"> 分类列表</a-col>
                                <a-col :span="15"></a-col>
                                <a-col :span="5" class="text-right">
                                    <a-button type="primary" @click="addCategory()"> 添加主分类</a-button>
                                </a-col>
                            </a-row>
                        </template>
                    </a-table>
...
<script>
    ...
    const columns = [
        ...
        },
        {
            title: '子分类',
            dataIndex: 'cat_fid',
            scopedSlots: {customRender: 'cat_fid'},
        },
        {
            title: '排序',
            dataIndex: 'cat_sort',
    ...
    export default {
        ...
        methods: {
            ...
            getChildList(cat_fid) {
            },
            addCategory() {
                this.fileList = [] //图片logo
                this.fileList1 = []//广告图片
                this.visible = true
                this.formData = {
                    //表单数据
