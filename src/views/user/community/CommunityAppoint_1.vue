    ...
    <div style="background: rgb(255, 255, 255);">
      <div style="margin:25px">
        <a href="/" class="login-header-left-img" >
          <img v-if="config.site_logo!=''" :src="config.site_logo" alt="logo" style="height: 50px;vertical-align: top;margin-right: 16px; border-style: none;">
          </a>
      </div>
            ...
            <div class="main user-layout-register1" style="width: 428px;margin-left: 30%;margin-top: 3%;margin-bottom: 3%;">
              <a-form ref="formRegister" :form="form" id="formRegister">
                ...
                <a-popover
                 ...
                 <a-form-item v-if="config.open_bd_spread_new=='1'">
                  <a-input
                    size="large"
                    type="text"
                    @click="hide=false"
                    placeholder="请联系业务员或业务经理获取邀请码"
                    autocomplete="off"
                    v-decorator="['invitation_code', {initialValue:register_data.invitation_code}]"
                  ></a-input>
                  </a-form-item>
                ...
                <div class="user" style="text-align: center;margin-bottom: 15px;">
                  <label style="color: #ccc;">注册即表示同意
                    <router-link :to="{ name: 'communityLogin' }" style="color: #ccc;">《{{$store.getters.config.house_name}}注册协议》</router-link>
                  </label>
                </div>
...
<style lang="less" scoped>
  ...
  .but-t{
    border: 1px solid #ccc;width: 430px;margin-bottom: 30px;height: 40px;
  }
  .but-pack{
