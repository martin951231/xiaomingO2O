    ...
    <div>
            <template>
                <a-form layout="inline" :label-col="{ span: 2 }" :wrapper-col="{ span: 22 }">
                    ...
                    <a-row class="mb-20" v-if="formData.orderid">
                        <a-col :span="1"></a-col>
                        <a-col :span="10">
                            支付流水号: <span>{{formData.orderid}}</span>
                        </a-col>
                    </a-row>
                    <a-row class="mb-20" v-if="formData.third_id">
                        <a-col :span="1"></a-col>
                        <a-col :span="10">
                            第三方支付流水号: <span>{{formData.third_id}}</span>
                        </a-col>
                    </a-row>
                    <a-row class="mb-20">
                        <a-col :span="1"></a-col>
                    ...
                    <a-row class="mb-20" v-if="formData.pay_type">
                        ...
                        <a-col :span="10">
                            ...
                            <span v-if="formData.pay_type=='ecard'">一卡通支付</span>
                        </a-col>
                    </a-row>
                    <a-row class="mb-20">
                        <a-col :span="1"></a-col>
                    ...
                    <div v-if="formData.paid">
                        ...
                        <a-row class="mb-20" v-if="formData.internal_card_pay_money > 0">
                            <a-col :span="1"></a-col>
                            <a-col :span="10">
                                一卡通支付金额: <span>{{formData.internal_card_pay_money}}</span>
                            </a-col>
                        </a-row>
                        <div v-if="formData.write_list && formData.write_list.length">
                            <a-row>
                                <a-col :span="10" class="mr-10" style="margin-bottom:15px;font-weight:bold">
                                    自定义表单信息
                                </a-col>
                            </a-row>
                            <template v-for="(item,index) in formData.write_list">
                                <a-row class="mb-20" :key="index">
                                    <a-col :span="1"></a-col>
                                    <a-col :span="10">
                        ...
                        <div v-if="formData.userinput !=null ">
                            <a-row>
                                <a-col :span="10" class="mr-10" style="margin-bottom:15px;font-weight:bold">
                                    取票人信息
                                </a-col>
