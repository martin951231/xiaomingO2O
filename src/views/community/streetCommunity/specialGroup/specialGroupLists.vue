    ...
    <a-card :bordered="false">
      <div class="search-box" style="margin-bottom: 10px;">
        <a-row :gutter="48">
          ...
          <a-col :md="8" :sm="24">
            <a-input-group compact>
              <label style="margin-top: 5px;">特殊人群类型：</label>
              <a-select placeholder="请选择特殊人群类型" style="width: 180px;" v-model="search.type_name">
                <a-select-option value="1">刑满释放</a-select-option>
                <a-select-option value="2">社区矫正</a-select-option>
                <a-select-option value="3">重点青少年</a-select-option>
                <a-select-option value="4">吸毒</a-select-option>
                <a-select-option value="5">艾滋病</a-select-option>
                <a-select-option value="6">精神病</a-select-option>
              </a-select>
            </a-input-group>
          </a-col>
          <a-col :md="2" :sm="2">
...
<!--          <router-link :to="{ path:'/community/streetCommunity/ThreeLessons/MeetingList' }" style="color: #1890ff;">进入会议列表</router-link>-->
          <router-link :to="{ name:'groupRecord',params:{bind_id:record.id,type:4}}" style="color: #1890ff;">查看记录</router-link>
        </span>
        ...
        computed:{
            columns() {
                ...
                const columns = [
                    ...
                    {
                        title: '所属特殊人员类型',
                        dataIndex: 'user_special_groups_txt',
                        key: 'user_special_groups_txt',
                    },
                    {
                        title: '跟踪记录',
                        dataIndex: '',
