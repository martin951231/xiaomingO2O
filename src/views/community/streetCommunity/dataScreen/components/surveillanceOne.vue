...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
                console.log('视频简介1', streetCommunityApi.getEventVideo1Statistics)
                let self = this
                self.request(streetCommunityApi.getEventVideo1Statistics, {swap_community_id:this.swap_community_id}).then((res) => {
