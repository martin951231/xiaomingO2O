  ...
  <div class="current_4">
    ...
    <div class="right_content" v-if="isShowNewsList">
      <div class="right_content_top">
        ...
        <div class="right_content_top_title">{{titleBar? titleBar: '社区服务'}}</div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      getServiceCategory() {
        ...
        this.request(configVillageApi.getServiceCategory, {}, 'post').then((res) => {
      ...
      chooseNews(item, index) {
        ...
        this.params.page = 1
        this.getNewsList(item.cat_id, 2)
      },
