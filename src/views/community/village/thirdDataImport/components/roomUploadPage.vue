<template>
    <div class="room-upload-page-box">
        <div v-if="!isImporting">
            <div class="third-room-upload-page">
                <h4>上传 <b>房产信息</b> Excel 文件</h4>
               ...
               <p>
                ...
                <div style="display: flex; width: 50%;">
                    ...
                    <a-upload-dragger style="height: 150px;width: calc(100% - 82px); margin-left: 10px;" name="file" :multiple="false" :action="uploadUrl" :beforeUpload="beforeUploadExcel"
                        ...
                        :data="{upload_dir: 'thirdRoom', system_type: 'village', type: 'thirdRoomInfo'}">
    ...
    export default {
        ...
        methods: {
            ...
            startImport(){
                ...
                let that = this;
                this.request(villageNew.thirdStartRoomImport, {
