<template>
    <div class="charge-upload-page-box">
        <div v-if="!isImporting">
            <div class="third-charge-upload-page">
                <h4>上传 <b>账单信息</b> Excel 文件</h4>
                <p>您要从何处导入数据，请选择导入的 Excel 文件</p>
               <p>
                    注意事项：<br/>
                    1、导入成功后的信息，如果要修改信息不要变动关键字和房产。<br/>
                    2、导入成功后的信息，其关联的收费标准相关不要删除，否则二次导入会生成一条新的订单。<br/>
                    3、导入成功后的信息，修改金额相关和周期会生成一条新的订单。<br/>
                    4、如果有导出错误会立马自动下载对应错误信息excel表。<br/>
                </p>
                <div style="display: flex; width: 50%;">
                    ...
                    <a-upload-dragger style="height: 150px;width: calc(100% - 82px); margin-left: 10px;" name="file" :multiple="false" :action="uploadUrl" :beforeUpload="beforeUploadExcel"
                        ...
                        :data="{upload_dir: 'thirdCharge', system_type: 'village', type: 'thirdChargeInfo'}">
    ...
    export default {
        ...
        methods: {
            ...
            startImport(){
                ...
                let that = this;
                this.request(villageNew.thirdStartChargeImport, {
                    'inputFileName': that.pathUrl
                }).then((res) => {
