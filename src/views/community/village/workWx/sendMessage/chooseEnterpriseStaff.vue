<template>
  ...
  >
    <div class="container">
      <div class="box_left">
        <a-input-search style="margin-bottom: 8px" placeholder="搜索成员" @search="onSearch"/>
    ...
    export default {
        ...
        methods: {
            ...
            onSelect(selectedKeys, info) {
                ...
                /*var res = false;
                for(var i = 0; i < this.enterprise_staff_arr.length; i++){
                    if(selectedKeys[0] === this.enterprise_staff_arr[i]){
                        res =  true;
                        break;
                    }
                }
                if(res)
                    this.enterprise_staff_arr.unshift(selectedKeys[0]);
                else
                    this.enterprise_staff_arr.push(selectedKeys[0]);*/
            ...
            handleSubmit () {
                ...
                console.log('0319',external_userid_arr);
                that.$emit('change',external_userid_arr);
            },
            handleCancel () {
                this.visible = false;
            },
