    ...
    <a-card title="街道功能库">
      ...
      <div class="body-item" v-for="(item,index) in appList" :key="index">
        <div class="items">
          ...
          <a v-if="item.sub" @click="$refs.createModal.FunctionLibrary(item.module)"><div class="items-right">查看</div></a>
        </div>
      </div>
    </a-card>
...
<script>
    ...
    import withinLibrary from './withinFunctionLibrary.vue';
    ...
    export default {
        ...
        methods: {
            ...
            AppLists() {
                ...
                this.request(configVillageApi.functionLibraryData, param)
                    .then((res) => {
                        console.log('res', res)
