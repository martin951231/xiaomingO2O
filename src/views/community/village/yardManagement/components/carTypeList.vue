<template>
    <a-drawer title="车牌类型列表" :width="800" :visible="visible" @close="handleCancel" >
    ...
    export default {
        ...
        methods: {
            ...
            getCarType(){
                ...
                that.request(villageApi.getCarTypeA11,that.pageInfo).then((res) => {
            ...
            bind(record){
                ...
                let car_number_type=record.car_number_type
                that.request(villageApi.addCarTypeA11,{type_id,car_number_type,garage_id:this.garage_id}).then((res) => {
            ...
            unbind(record){
                ...
                let type_id=that.pageInfo.type_id
                let car_number_type=record.car_number_type
                that.request(villageApi.delCarTypeA11,{type_id,car_number_type,garage_id:this.garage_id}).then((res) => {
