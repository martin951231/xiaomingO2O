    ...
    <div class="message-suggestions-box-1">
        <a-table
            ...
            <span slot="action" slot-scope="text, record">
                <a v-if="record.isSyn!=1"  @click="$refs.bindDahuaYuiRuiData.bind(record, parent_bind_id)">绑定{{record.orgTypeTxt}}</a>
                <a v-if="record.isSyn==1"  @click="$refs.bindDahuaYuiRuiData.bind(record, parent_bind_id,'look')">查看{{record.orgTypeTxt}}</a>
            </span>
