<template>
    <div class="warranty-detail-box">
        <div class="warranty_details">
            <a-alert message="房间的质保类别可以修改保修期限，但是对应楼栋质保类别必须先进行设置且房间设置的质保类别保修期限不能超过楼栋设置的范围"/>
            <div class="btn_con">
...
<script>
    ...
    import vertifyCategory from '@/views/community/village/building/components/module/vertifyCategory.vue';
    import applyList from '@/views/community/village/building/components/module/applyList.vue';
        ...
        setup(props, context) {
            ...
            const getArrantyList = () => {
                Vue.prototype.request(
                    '/community/village_api.workorder.CommunityQuality/getRoomCommunityQualityInfo', {
                    ...
                    state.arrantyList.map(v => {
                        ...
                        if (v.quality_start_time_text && v.quality_end_time_text) {
                            v.repaireDate = [moment(v.quality_start_time_text, 'YYYY-MM-DD'), moment(v.quality_end_time_text, 'YYYY-MM-DD')]
                        }
                        ...
                        if (v.fid_category_name && v.category_name) {
                            v.categoryName = v.fid_category_name + '/' + v.category_name
                        }
                    })
                })
            }
            ...
            const handleConfirm = () => {
                ...
                Vue.prototype.request('/community/village_api.workorder.CommunityQuality/setRoomCommunityQuality', {
                    qualityParams,
                    room_id: props.roomId
                }).then(res=>{
