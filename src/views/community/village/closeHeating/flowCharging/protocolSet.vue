    ...
    <a-spin :spinning="confirmLoading" :height="800">
      <a-form :form="form">
          <a-form-item label="" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-col :span="30">
                  <span class="box_width label_col ant-form-item-required" style="width: 140px !important;">流量计费协议展示</span>
...
<script>
  ...
  export default {
    ...
    methods: {
        set() {
            let that = this
            that.request(villageApi.getFlowChargingProtocol).then((res) => {
                that.data = res
                this.visible = true;
            })
        },
        ...
        // }
          ...
          validateFields((errors, values) => {
              if (!errors) {
                  ...
                  let that = this
                  that.request(villageApi.editFlowChargingProtocol,indexParams).then((res) => {
