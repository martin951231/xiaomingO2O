<template>
    <div class="message-suggestions-list-box userList" >
        ...
        <div class="add-box">
            <a-row :gutter="48">
                <a-col :md="5" :sm="24" style="width: 40% !important;">
                    <a-button type="primary" @click="$refs.ArrangingSetModel.info(1)" >排号规则设置</a-button>
                </a-col>
            </a-row>
        </div>
        <a-table
            ...
            <span slot="action" slot-scope="text, record">
                ...
                <a class="but_sty" @click="handleRentContract(record)" v-if="record.button.is_contract">生成合同</a>
                <a-popconfirm
        ...
        <rentfillModal v-if="showRentFill" :visible="showRentFill" :rentRecord="rentRecord" :title="rentFillTitle" @exit="closeRentFill" :rent_type="rent_type" @ok="callback"/>
...
<script>
    ...
    import choiceContract from './choiceContract';
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                this.request(villageApi.publicRentalHandleApplyList, this.search).then((res) => {
