        ...
        <div class="search-box">
          <a-row  style="display: flex; flex-wrap: wrap;margin-top: 20px;margin-bottom: 10px;">
                ...
                <a-col :md="2"  style="width: 100px;padding-left: 1px; margin-left: 20px;">
                    <a-button type="primary" @click="$refs.roomRateSummaryRecord.showRateSummaryRecord({rate_type:0,xtype:0})" >历史快照</a-button>
                </a-col>
  ...
  export default {
    ...
    methods: {
      getVillageRoomFeeRateList() {
          this.request(villageApi.getVillageRoomFeeRateList, this.search)
            .then((res) => {
              this.list = res.list;
            }).catch((error) => {
