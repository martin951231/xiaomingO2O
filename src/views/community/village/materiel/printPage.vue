    ...
    <a-modal :title="title" :width="1300" :visible="visible" :footer="null" :maskClosable="false"
        ...
        <a-table
          ...
          :loading="confirmLoading">
            ...
            <div class="module_two" style="display: flex; flex-direction: column;">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            add(order_id, template_id, pigcms_id = 0, choice_ids = [], printTempLateType = '') {
                console.log('order_id>>>>>>>>>', order_id)
                console.log('template_id>>>>>>>>>', template_id)
                console.log('pigcms_id>>>>>>>>>', pigcms_id)
                console.log('choice_ids>>>>>>>>>', choice_ids)
                console.log('printTempLateType>>>>>>>>>', printTempLateType)
            ...
            getPrintInfo() {
                ...
                this.request(villageApi.getPrintInfo, {
                        ...
                        printTempLateType: this.printTempLateType
                    })
                    .then((res) => {
