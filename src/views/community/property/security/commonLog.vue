<template>
    <div class="package-list ant-pro-page-header-wrap-children-content" style="margin:24px 0 0;">
        <a-card :bordered="false">
            ...
            <property-common-info :log_fid="log_fid"   :visible="drawerVisible" @closeDrawer="closeDrawer" />
        </a-card>
...
import propertyCommonInfo from "@/views/community/property/security/commonInfo";
...
export default {
    ...
    methods: {
        getLogDataList() {
            ...
            this.request(propertyApi.commonLog, {'page': this.page,'parent_id':0})
                .then((res) => {
                    console.log('res', res);
                    this.list = res.list;
