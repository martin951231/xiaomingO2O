...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getRecordDataList() {
                this.loading = true
                this.request(newChargeApi.getPropertyRateSummaryRecordList, this.param)
                    .then((res) => {
