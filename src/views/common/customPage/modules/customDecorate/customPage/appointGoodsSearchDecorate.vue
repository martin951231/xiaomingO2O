    ...
    <div v-if="formDataDecorate">
        ...
        <div class="content">
            <a-form-model
                ...
                :labelAlign="'left'"
            >
                <a-form-model-item :label="L('框体样式')">
                    <div class="flex align-center justify-between">
                        <span>{{ getLabel(styleTypeOptions, formDataDecorate.style_type) }}</span>
                        <div>
                            <a-radio-group v-model="formDataDecorate.style_type" button-style="solid">
                    ...
                    <div class="flex align-center justify-between">
                        ...
                        <div>
                            <a-radio-group v-model="formDataDecorate.text_align" button-style="solid">
                                <a-radio-button v-for="item in textAlignOptions" :key="item.value" :value="item.value">
                                    <IconFont :type="item.icon" class="itemIcon" />
                                </a-radio-button>
                            </a-radio-group>
                        </div>
                ...
                <a-form-model-item :label="L('框体高度')">
                    <a-slider v-model="formDataDecorate.height_value" :max="40" :min="28" />
                </a-form-model-item>
                ...
                <a-form-model-item :label="L('背景透明度')" class="flex-end">
                    <a-row>
                        ...
                        <a-col :span="4" :offset="1">
                            <a-input-number
                                v-model="formDataDecorate.bg_color_opacity"
                                :min="0"
                                :max="1"
                                :step="0.1"
                            />
                ...
                <a-form-model-item :label="L('框体颜色')" class="flex-end">
                    <div class="flex align-center color-picker-wrap">
                        ...
                        >
                            <input type="color" v-model="formDataDecorate.content_bg_color" id="content_bg_color" />
                        </label>

                        <a-button @click="resetOpt('content_bg_color')" type="link"> {{ L('重置') }}</a-button>
                    </div>
                </a-form-model-item>
