    ...
    <div class="message-suggestions-list-box">
        ...
        <a-row >
            <a-col :md="2" :sm="24" style="width: 400px;margin-left: 50px;padding-top: 15px;">
                <a-button  type="primary" @click="$refs.hotWordAddOrEdit.editword(0)">新建关键词</a-button>
            </a-col>
        </a-row>
        <a-table
                :columns="columns"
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                this.request(hotWordManageApi.getHouseHotWordLists, this.search)
                    .then((res) => {
            ...
            setWordStatus(record,status){
                ...
                this.request(hotWordManageApi.setHouseHotWordStatus, postArr)
                    .then((res) => {
            ...
            delHotWord(record){
                ...
                this.$confirm({
                  ...
                  onOk() {
                      _this.request(hotWordManageApi.deleteHouseHotWord, postArr)
                        .then((res) => {
