    ...
    <div class="message-suggestions-list-box">
        ...
        <a-row>
            <a-col style="margin-bottom: 18px;">
                <a-button type="primary" @click="addCategory"  style="margin-right: 20px;" v-if="role_addcategory==1">新建分类</a-button>
        ...
        <a-table :columns="columns" :data-source="data" class="components-table-demo-nested" :pagination="pagination"
            ...
            <span slot="manageaction" slot-scope="text, record,index">
                <a-button type="default" @click="$refs.materialModel.xList(record,3)" v-if="role_managecategory==1"> 管 理 </a-button>
            </span>
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                this.search['xtype'] = 3;
                this.request(hotWordManageApi.getHouseHotWordMaterialCategoryLists, this.search)
                    .then((res) => {
            ...
            delCategory(record) {
                ...
                this.request(hotWordManageApi.deleteHouseHotWordMaterialCategory, postArr)
                    .then((res) => {
            ...
            delCategoryMany() {
                ...
                this.$confirm({
                    ...
                    onOk() {
                        _this.request(hotWordManageApi.deleteHouseHotWordMaterialCategory, postArr)
                            .then((res) => {
            ...
            handleCategorySubmit() {
                ...
                this.request(hotWordManageApi.saveMaterialCategoryData, postArr).then((res) => {
                    this.confirmLoading = false;
