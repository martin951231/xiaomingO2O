    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                this.request(hotWordManageApi.getHouseHotWordMaterialLists, this.search)
                    .then((res) => {
                        console.log(123,res);
            ...
            delMaterial(record) {
                ...
                this.request(hotWordManageApi.deleteHouseHotWordMaterialContent, postArr)
                    .then((res) => {
            ...
            delMaterialMany() {
                ...
                this.$confirm({
                    ...
                    onOk() {
                        _this.request(hotWordManageApi.deleteHouseHotWordMaterialContent, postArr)
                            .then((res) => {
            ...
            handleMaterialSubmit() {
                ...
                this.request(hotWordManageApi.saveHouseHotWordMaterialSetData, postArr).then((res) => {
                    this.confirmLoading = false;
