    ...
    <a-layout>
        ...
        >
            <a-tabs default-active-key="1">
                <a-tab-pane key="1" tab="推送内容查看">
                    <a-form v-bind="{ labelCol: { span: 2 }, wrapperCol: { span: 5 }, }">
                        <a-row>
                            <a-col class="label-font-size text-center" :span="2">
                                <a-button type="default" @click="returnBack()"><a-icon type="left" /></a-button>
                            </a-col>
                        </a-row>
                        <br>
                        <a-row>
                        ...
                        <a-form-item label="所属分类">
                            <a-select v-model="formData.category_type" disabled>
                                <a-select-option
                        ...
                        <a-form-item label="渠道展示" :wrapper-col="{ span: 10}" disabled="true">
                            <a-row>
                                <a-col :span="24">
                        ...
                        <a-form-item label="推送人群" disabled="true">
                            <a-row>
                                <a-col :span="24">
                                    <a-radio-group v-model="formData.users" disabled>
                                        <a-radio :value="0">
                                            全部
                                        </a-radio>
                                        <a-radio :value="1">
                            ...
                            <template v-if="formData.users">
                                <a-row>
                                    <a-col :span="24">
                                        <a-col :span="3">
                                            <a-checkbox @change="onChange" :checked="formData.user.area_sel" disabled>
                                            </a-checkbox>
                                        </a-col>
                                ...
                                <a-row>
                                    <a-col :span="24">
                                        <a-col :span="3">
                                            <a-checkbox @change="onChange1" :checked="formData.user.level_sel" disabled>
                                            </a-checkbox>
                                        </a-col>
                                        <a-col :span="5">用户等级:</a-col>
                                        <a-col :span="16">
                                            <a-select v-model="formData.user.level" disabled>
                                                <a-select-option
                                ...
                                <a-row>
                                    <a-col :span="24">
                                        <a-col :span="3">
                                            <a-checkbox @change="onChange2" :checked="formData.user.label_sel" disabled>
                                            </a-checkbox>
                                        </a-col>
                        ...
                        <a-form-item label="推送端口" :wrapper-col="{ span: 17}">
                            <a-row>
                                <a-col :span="24">
                                    <a-radio-group v-model="formData.send_port" disabled>
                                        <a-radio :value="0">
                                            全部
                                        </a-radio>
                                        <a-radio :value="1">
                            ...
                            <a-row>
                                <a-col :span="1" class="text-center">
                                    <a-checkbox @change="onChange3" :checked="is_set_send_time"
                                                v-model="is_set_send_time" disabled>
                                    </a-checkbox>
                                </a-col>
                                ...
                                <template v-if="is_set_send_time">
                                    <a-col :span="4">
                                        <a-date-picker
                                                ...
                                                :default-value="moment(formData.set_send_time_date, 'YYYY-MM-DD')"
                                    ...
                                    <a-col :span="4">
                                        <a-time-picker
                                                format="HH:mm"
                                                :default-value="moment(formData.set_send_time_min, 'HH:mm')"
                                                placeholder="选择时间"
                                                @change="onChangeTime"
                                                disabled />
                                    </a-col>
                        ...
                        <br>
                        <a-form-item label="主标题:" :wrapper-col="{ span: 7}">
                            <a-row>
                                <a-col :span="18">
                                    <a-input
                                            placeholder="请输入消息标题"
                                            v-model="formData.title" disabled />
                                </a-col>
                        ...
                        <a-form-item label="描述" :wrapper-col="{ span: 7}" disabled="true">
                            <a-row>
                                <a-col :span="18">
                                    <a-input
                                            placeholder="请输入消息描述"
                                            v-model="formData.desc" disabled>
                                    </a-input>
                                </a-col>
                                <a-col :span="4" class="text-left font-color">
                                    1-50个字符
                        ...
                        <a-form-item label="标题图片" v-if="formData.img">
                            <a-row>
                        ...
                        <a-form-item label="信息链接类型:" disabled="true">
                            <a-row>
                                <a-col :span="24">
                                    <a-radio-group v-model="formData.content_type" disabled>
                                        <a-radio :value="0">
                                            富文本
                                        </a-radio>
                                        <a-radio :value="1">
                        ...
                        <template v-else>
                            <a-form-item label="富文本" :wrapper-col="{ span: 20}">
                                <a-row>
                                    <a-col :span="13">
                                        <div class="flex">
                                            <rich-text :info.sync="formData.content" disabled />
                                        </div>
                                    </a-col>
                                </a-row>
                            </a-form-item>
        ...
        methods: {
            ...
            getLists() {
                this.request(mailPlatformApi.mailEdit, this.queryParam).then((res) => {
                    ...
                    this.$set(this, 'formData', res.list)
                    this.formData = res.list
                    if (res.list.set_send_time > 0) {
                        this.is_set_send_time = true
                    }
                    this.formData.user = res.list.users_label
